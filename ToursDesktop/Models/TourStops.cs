	...
	public class TourSource {
		...
		static TourSource() {
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUrl = "/Images/StopPastry.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				ImageUrl = "Images/StopFountain.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUrl = "/Images/StopArtInstitute.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUrl = "/Images/StopGarden.jpg"
			});
			...
			_tourStops.Add(new TourStop
			{
				...
				,
				ImageUrl = "/Images/StopPretzel.jpg"
			});
		}
